...
export default function BottomRightCorner() {
  ...
  return (
    <motion.div
      ...
      className="absolute bottom-0 right-0 p-3 pt-5 pl-8 sm:p-4 sm:pt-6 sm:pl-10 md:p-6 md:pt-8 md:pl-14 bg-[#f0f0f0] rounded-tl-[1.5rem] sm:rounded-tl-[2rem] md:rounded-tl-[3.5rem] flex items-center gap-3 sm:gap-4 md:gap-6 z-20 pointer-events-auto cursor-pointer"
    ...
    >
      ...
      <div className="bg-[rgba(30,50,90,0.05)] w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center border border-[rgba(30,50,90,0.1)] hover:bg-[rgba(30,50,90,0.1)] transition-colors">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-1 text-[rgba(30,50,90,0.6)] hover:text-[rgba(30,50,90,0.8)] transition-colors">
          <span className="text-[12px] md:text-[15px] font-normal">O'qish</span>
